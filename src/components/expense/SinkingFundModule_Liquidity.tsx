      ...
      {activeFunds.length === 0 ? (
        ...
        <div className="grid grid-cols-1 gap-4">
          {activeFunds.map((fund) => {
            ...
            const renderDisburseForm = (fund: any) => (
                  <div className="p-3 bg-green-50 rounded-lg border border-green-200">
                    ...
                    <div className="space-y-2 border-t border-green-200 pt-2">
                      ...
                      <div className="flex justify-end gap-2 pt-2 items-center flex-wrap">
                        ...
                        {(() => {
                          if (settleMode === 'partial') {
                             ...
                             if (wAmt > balance) {
                                 return (
                                    <div className="w-full text-red-600 text-[11px] font-bold mt-1 mb-1 bg-red-50 p-2 rounded animate-pulse text-right">
                                         ⚠️ Số tiền rút không được vượt quá số dư hiện tại của quỹ là {formatTableMoneyVNDMillion(balance)} triệu.
                                    </div>
                                 );
                             }
                          }
                        ...
                        <div className="w-full flex justify-end gap-2">
                           ...
                           <Button 
                             ...
                             disabled={
                               !isWithinObservationPeriod(disburseForm.disbursedMonth, disburseForm.disbursedYear, selectedPeriodKey) ||
                               (settleMode === 'partial' && (partialWithdrawType === 'amount' ? partialWithdrawValue : (balance * partialWithdrawValue / 100)) > balance)
                             }
                             onClick={() => {
                            if (settleMode === 'full') {
            ...
            return (
              <div key={fund.id} className="relative mt-2 pt-2">
